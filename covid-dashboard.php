...
form #logout{
 ...
 <div class="main-content" style="background-color: #17a2b8;" >
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                                ...
                                <div class="overview-item overview-item--c5">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Delhi Confirmed Cases</span>
                                ...
                                <div class="overview-item overview-item--recovered">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Delhi Recovered Cases</span>
                                ...
                                <div class="overview-item overview-item--death">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Delhi Death Cases</span>
                                                <h2 id="StateDeath"></h2>
                                            </div>
                                            <div class="progress">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Covid19 Cases In Delhi</h2>
                            ...
                            <div class="col-lg-3">
                               ...
                               <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Covid19 Test Cases In Delhi</h2>
                                <div class="table-responsive table--no-card m-b-40">
                                      ...
                                      <div class="au-card chart-percent-card" style="height: 580px;" id="testing">
                                        <div class="au-card-inner">
                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-lg-12">
                                                    <iframe src="https://www.google.co.in/maps/d/embed?mid=1u0A0IbVH8mzJUhonMyqSzwHPVytsGBbz" width="100%" height="380"></iframe>
                                                </div>
                                            </div>    
                                        </div>    
                                     </div>
                            ...
                            <div class="col-lg-12">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" >
                                        ...
                                        <h3>
                                            <i class="zmdi zmdi-account-calendar"></i>Updates</h3>
                                    ...
                                    <div class="au-task js-list-load">
                                        ...
                                        <div class="au-task-list js-scrollbar3">
                                            <div class="au-task__item au-task__item--danger">
                                                <div class="au-task__item-inner">
                                                    <iframe src="https://www.google.com/maps/d/embed?mid=1X11pR1yEU4F2gxG3NlHM_c69LbW0uRWS" width="100%" height="480"></iframe>
                                                </div>
                                            </div>
                                        </div>
                                        <br><br>
                                        <div class="au-task-list js-scrollbar3">
                                            <div class="au-task__item au-task__item--danger">
                                                <div class="au-task__item-inner">
                                                    <iframe src="https://www.google.com/maps/d/embed?mid=12TJ1OSoVNvvQN-OSlwR9r5U6TPCarhik" width="100%" height="480"></iframe>
                                                </div>
                                            </div>
                                        </div>
                                        <br><br>
                                        <div class="au-task-list js-scrollbar3">
                                            <div class="au-task__item au-task__item--danger">
                                                <div class="au-task__item-inner">
                                                    <iframe src="https://www.google.com/maps/d/embed?mid=1AYoIwtRv9comb2UkGppQS1EoD1_kGgWb" width="100%" height="480"></iframe>
                                                </div>
                                            </div>
                                        </div>
                                        <br><br>
                                        <div class="au-task-list js-scrollbar3">
                                            <div class="au-task__item au-task__item--danger">
                                                <div class="au-task__item-inner">
                                                    <iframe src="https://www.google.com/maps/d/embed?mid=1o5v1dfgrtjHU-RzvUI5tKHbxedlR6_e6" width="100%" height="480"></iframe>
                                                </div>
                                            </div>
                                        </div>
                                        <br><br>
